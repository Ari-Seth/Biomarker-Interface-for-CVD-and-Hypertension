...
st.markdown(f'<div class="overall-banner" style="background:{overall_color};">{overall}</div>', unsafe_allow_html=True)
st.markdown(f"""
<div class="meta-row">
...
st.markdown("</div>", unsafe_allow_html=True)
st.markdown('<div class="footer-note">Wearable biosensor interface concept for continuous ISF-based cardiovascular monitoring</div>', unsafe_allow_html=True)
st.markdown("</div>", unsafe_allow_html=True)
